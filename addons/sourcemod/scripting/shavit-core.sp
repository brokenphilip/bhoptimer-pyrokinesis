...
public void OnPluginStart()
{
	...
	gCV_SaveIps = new Convar("shavit_core_save_ips", "0", "Whether to save player IPs in the 'users' database table. IPs are used to show player location on the !profile menu.\nTurning this off will not wipe existing IPs from the 'users' table.", 0, true, 0.0, true, 1.0);
